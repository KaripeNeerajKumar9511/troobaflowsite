      ...
      <>
        ...
        <main className="pt-24 pb-12 min-h-screen flex items-center justify-center px-6">
          <div className="text-center max-w-md">
            ...
            <p className="text-font-mono/60">We'll be in touch within 2 business days.</p>
          </div>
        </main>
        <Footer />
      </>
      ...
      <main className="pt-24 pb-12">
        <div className="max-w-2xl mx-auto px-6">
          <ScrollReveal>
            ...
            <p className="text-font-mono/60 text-lg mb-12 leading-relaxed">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <p className="text-font-mono/70">{step}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <ScrollReveal>
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Name</label>
                <input
                  required
                  value={form.name}
                  onChange={(e) => setForm({ ...form, name: e.target.value })}
                  className="w-full bg-transparent border border-font-mono/[0.12] rounded-md px-4 py-3 text-font-mono placeholder:text-trooba-mid/50 focus:outline-none focus:border-trooba-teal transition-colors"
                />
              </div>
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Company</label>
                <input
                  required
                  value={form.company}
              ...
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Company location</label>
                <input
                  required
              ...
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Contact email</label>
                <input
                  type="email"
                  required
                  autoComplete="email"
              ...
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Contact phone</label>
                <input
                  type="tel"
                  required
                  autoComplete="tel"
              ...
              <div> 
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Role</label>
                <input
                  required
                  value={form.role}
              ...
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Manufacturing Type</label>
                <select
                  required
                  value={form.mfgType}
                  onChange={(e) => setForm({ ...form, mfgType: e.target.value })}
                  className="w-full bg-transparent border border-font-mono/[0.12] rounded-md px-4 py-3 text-font-mono focus:outline-none focus:border-trooba-teal transition-colors"
                >
              ...
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Active SKUs</label>
                <select
                  required
                  value={form.skuCount}
              ...
              <div>
                <label className="block font-mono text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Your biggest production challenge</label>
                <textarea
                  required
                  rows={3}
                  value={form.challenge}
                  onChange={(e) => setForm({ ...form, challenge: e.target.value })}
                  className="w-full bg-transparent border border-font-mono/[0.12] rounded-md px-4 py-3 text-font-mono placeholder:text-trooba-mid/50 focus:outline-none focus:border-trooba-teal transition-colors resize-none"
                />
              </div>
              {error && (
