  ...
  <section className="section-padding px-6">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Tarinika */}
        <ScrollReveal>
          <div className="border border-font-mono/[0.08] rounded-lg p-6 lg:p-8 h-full" style={{ backgroundColor: "rgba(30,58,95,0.2)" }}>
            <div className="flex flex-wrap items-start justify-between gap-2 mb-4">
              <span className="font-mono text-[12px] tracking-[0.18em] uppercase" style={{ color: "rgb(255,255,255)" }}>Jewelry Manufacturing</span>
            ...
            <div className="mt-6 mb-6 space-y-3">
              <div className="flex items-center gap-3">
                <span className="font-mono text-[12px] w-12" style={{ color: "rgb(255,255,255)" }}>Before</span>
                <div className="flex-1 h-5 bg-trooba-mid/30 rounded relative">
                  <span className="absolute right-2 top-0.5 font-mono text-[12px]" style={{ color: "rgb(255,255,255)" }}>28 days</span>
                </div>
              </div>
              <div className="flex items-center gap-3">
        ...
        <ScrollReveal>
          <div className="border border-font-mono/[0.08] rounded-lg p-6 lg:p-8 h-full" style={{ backgroundColor: "rgba(30,58,95,0.2)" }}>
            <div className="flex flex-wrap items-start justify-between gap-2 mb-4">
              <span className="font-mono text-[12px] tracking-[0.18em] uppercase" style={{ color: "rgb(255,255,255)" }}>Corrugated Carton Mfg · ~300 SKUs</span>
            ...
            <span className="font-mono text-[14px] tracking-[0.15em]" style={{ color: "rgb(255,255,255)" }}>Findings updated as they emerge.</span>

            <div className="mt-6 mb-6">
              <h4 className="font-mono text-[12px] tracking-[0.18em] uppercase mb-3" style={{ color: "rgb(255,255,255)" }}>What we're doing</h4>
            ...
            <div>
              <h4 className="font-mono text-[12px] tracking-[0.18em] uppercase mb-3" style={{ color: "rgb(255,255,255)" }}>Live Findings</h4>
            ...
            <p className="font-mono text-[12px] tracking-wider uppercase mt-6" style={{ color: "rgb(255,255,255)" }}>
